...
`blockLessonCalendars.seed.json` mirrors `curriculum/website-data/blockLessonCalendars.seed.json` and is the combined site preview feed used by `/teacher/schedule`.
